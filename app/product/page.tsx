      ...
      <div className="grid lg:grid-cols-2 gap-x-16 gap-y-12">
        ...
        <div className="hidden lg:block pt-6 border-t border-white/10">
            ...
            <div className="space-y-4">
              ...
              <div className="p-6 bg-[#050505] border border-white/10 rounded-xl">
                <div className="flex text-[#C5A46E] mb-2">★★★★★</div>
                <p className="text-sm text-white/80 mb-2">"After using zulfhair oil my my hair fall reduced. I felt prominent reduced of dandruff..it moisturize my dry scalp and reduced itching..an exceptional result was it also help to minimize head lices😊😊"</p>
        ...
        <div className="flex flex-col">
          ...
          <div className="space-y-8 md:space-y-10 text-white/80 leading-relaxed text-[15px] md:text-base">
            ...
            <div>
              ...
              <div className="relative w-full mb-8 mt-6 rounded-xl overflow-hidden border border-white/10">
                <img src="/images/product/kachi-ghani.webp" alt="Kachi Ghani Wood-Pressed Extraction" className="w-full h-auto" />
              </div>
